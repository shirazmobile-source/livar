    ...
    <header class="doc-header">
        <div class="doc-brand">
            ...
            <div class="doc-company">
                <h1><?= e($template['title'] ?? 'Supplier Statement') ?></h1>
        ...
        <div class="doc-header-side">
            <div class="doc-card">
                <div class="doc-meta-grid">
                    <div><small>Supplier</small><strong><?= e((string) ($supplier['name'] ?? $supplier['code'])) ?></strong></div>
                    <div><small>Code</small><strong><?= e((string) $supplier['code']) ?></strong></div>
                    ...
                    <div><small>Status</small><strong><?= e(ucfirst((string) ($supplier['status'] ?? 'active'))) ?></strong></div>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="doc-kpis">
                <?php foreach ($summaryByCurrency as $summary): ?>
                    <div class="doc-kpi">
                        ...
                        <div class="muted">Purchases <?= e(money_currency($summary['purchase_total'] ?? 0, $summary['currency_code'] ?? 'AED')) ?></div>
                        <div class="muted">Paid <?= e(money_currency($summary['paid_total'] ?? 0, $summary['currency_code'] ?? 'AED')) ?></div>
                    </div>
                <?php endforeach; ?>
            </div>
        </section>
